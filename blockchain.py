...
class Block:
    def __init__(self, index, transactions, timestamp, previous_hash, nonce=0):
        ...
        self.nonce = nonce
        print(
            f"Initializing new block with index: {index}, transactions: {transactions}, timestamp: {timestamp}, previous hash: {previous_hash}, nonce: {nonce}")

    def compute_hash(self):
        """
        A function that return the hash of the block contents.
        """
        print("Computing hash for the block...")
